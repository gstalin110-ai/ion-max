...
**Plataforma de ecosistema profesional con SHOP, RED SOCIAL profesional.**

- 🌐 [Sitio en vivo](https://ion-max.vercel.app)
- 📱 **PWA Descargable** - Instalable como app nativa
- 🔐 Autenticación con Supabase (Email/Password)
- 📱 Diseño responsive y mobile-first
- ⚙️ Panel admin CRUD
- 👥 Red social profesional (Comunidad y Mensajes)
- 💳 Sistema de pagos con QR/Link (PayPhone/Kushki)
